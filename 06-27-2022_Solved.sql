...
create table emp(id number,name varchar(50),designation varchar(50),salary number);
...
SELECT designation,count(designation) from emp where salary > 500 group by designation;
